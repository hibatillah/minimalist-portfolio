...
const Github = () => {
  return (
    <svg
      ...
      fill="currentColor"
      class="bi bi-github w-6 h-6 fill-dark dark:fill-profile"
      viewBox="0 0 16 16"
    >
...
const Instagram = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
      class="bi bi-instagram w-6 h-6 fill-dark dark:fill-profile"
      viewBox="0 0 16 16"
    >
...
const Email = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
      class="bi bi-envelope w-6 h-6 fill-dark dark:fill-profile"
      viewBox="0 0 16 16"
    >
...
const LinkedIn = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
      class="bi bi-linkedin w-6 h-6 fill-dark dark:fill-profile"
      viewBox="0 0 16 16"
    >
        ...
        {socmed.map((item, index) => (
          <li key={index} className="group/socmed">
            <a href={item.link} target="_blank" rel="noopener noreferrer">
              <div className="w-[50px] h-[50px] grid place-items-center border border-profile rounded-full select-none press active:bg-profile/50 group-hover/socmed:-translate-y-1 lg:w-12 lg:h-12 dark:border-grey/50 dark:active:bg-grey/20">
                {(() => {
                  switch (item.name) {
                    case "Email":
                      return <Email />;
